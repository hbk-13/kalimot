...
###
#    KALIMOT
#    This script runs RAP or Kali Cloud
#    Usage: ./kalimot.sh
###

rapgw() {
    echo "[*] Entering RAP Gateway"
    ssh ${1}@rapgw.vikingcloud.com
}
...
"
    ...
    case $option in
        1) rapgw ${USERNAME}; exit 0;;
	2) rap ${USERNAME}; exit 0;;
        3) rap_proxychains ${USERNAME}; exit 0;;
        4) rap_socks_proxy ${USERNAME}; exit 0;;
        5) kali1 ${USERNAME}; exit 0;;
        6) kali2 ${USERNAME}; exit 0;;
